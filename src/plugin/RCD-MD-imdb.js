...
const imdb = async (m, gss) => {
  try {
    ...
    let trailerLink = `https://www.youtube.com/results?search_query=${encodeURIComponent(fids.data.Title + ' trailer')}`;
    imdbt += `▶️Trailer    : [Click here for the trailer](${trailerLink})\n`;
